export let texts = [
    {
        ...
        "title": "Animations",
        "body": `
            Quant-UX supports two kind of animations. Widget animations change the style of a widget, depending on the
        ...
        "paragraphs": [
            ...
            },
            {
                ...
                "body": `
                    ...
                    The animation composer will show up, which let's you define for each widget an animation 
            ...
            },
            {
                ...
                "body": `
                    ...
                    special kind of links create under the hoods for every widget a transorm animation that 
                    is shown when the screen is loaded. The best way to work with animation links is to:
                    <ol>
                        <li>
